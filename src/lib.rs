...
pub mod col_vec_iterators {
    ...
    impl<I: Iterator,const D: usize> EvalColVec<I,D> where I::Item: Clone {
        #[inline]
        pub fn unchecked_duplicate(self) -> (EvalColVec<FirstUncheckedDuplicateColVec<I,D>,D>,EvalColVec<SecondUncheckedDuplicateColVec<I,D>,D>) {
    ...
    impl<I: IntoIterator,const D: usize> ColumnVec<I,D> where I::Item: Clone {
        #[inline]
        pub fn unchecked_duplicate(self) -> (EvalColVec<FirstUncheckedDuplicateColVec<I::IntoIter,D>,D>,EvalColVec<SecondUncheckedDuplicateColVec<I::IntoIter,D>,D>) {
            let shared_iter = std::rc::Rc::new(utils::UncheckedCell::new(UncheckedDuplicatedColVec{
                iterator: self.0.into_iter(),
                buffer: None
            }));
        ...
        #[inline]
        pub fn unchecked_duplicate_ref<'a>(&'a self) -> (EvalColVec<FirstUncheckedDuplicateColVec<<&'a I as IntoIterator>::IntoIter,D>,D>,EvalColVec<SecondUncheckedDuplicateColVec<<&'a I as IntoIterator>::IntoIter,D>,D>) 
        where &'a I: IntoIterator, <&'a I as IntoIterator>::Item: Clone {
            let shared_iter = std::rc::Rc::new(utils::UncheckedCell::new(UncheckedDuplicatedColVec{
                iterator: (&self.0).into_iter(),
                buffer: None
...
mod test {
    ...
    fn unchecked_duplicate_test() {
        let (x,y) = ColumnVec::from([1,2,3,4,5]).unchecked_duplicate();
    ...
    fn unchecked_duplicate_stress_test() {
        ...
        for _ in 0..1000000 {
            ...
            let (clone_a,clone_b) = original.clone().unchecked_duplicate();
