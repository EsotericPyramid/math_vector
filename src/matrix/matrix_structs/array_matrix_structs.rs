    ...
    <M::FstHandleBool as TyBool>::Neg: Filter,
{
    pub(crate) mat: M,
    pub(crate) buf:
        [[MaybeUninit<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>>; D1]; D2],
}
    ...
    (M::FstOwnedBufferBool, <M::FstHandleBool as TyBool>::Neg): TyBoolPair,
{
    ...
    type FstOwnedBuffer =
        <(M::FstHandleBool, <M::FstHandleBool as TyBool>::Neg) as SelectPair>::Selected<
            M::FstOwnedBuffer,
            MathMatrix<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>, D1, D2>,
        >;
    type SndOwnedBuffer = M::SndOwnedBuffer;
            ...
            <(M::FstHandleBool, <M::FstHandleBool as TyBool>::Neg) as SelectPair>::select(
                ...
                MatrixExpr(Owned2DArray(mem::transmute_copy::<
                    [[MaybeUninit<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>>; D1];
                        D2],
                    ManuallyDrop<
                        [[<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>; D1]; D2],
                    >,
                >(&self.buf))),
            )
        }
    ...
    <M::FstHandleBool as TyBool>::Neg: Filter,
{
    ...
    pub(crate) buf: ManuallyDrop<
        Box<[[MaybeUninit<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>>; D1]; D2]>,
    >,
}
    ...
    (M::FstOwnedBufferBool, <M::FstHandleBool as TyBool>::Neg): TyBoolPair,
{
    ...
    type FstOwnedBuffer =
        <(M::FstHandleBool, <M::FstHandleBool as TyBool>::Neg) as SelectPair>::Selected<
            M::FstOwnedBuffer,
            Box<MathMatrix<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>, D1, D2>>,
        >;
    type SndOwnedBuffer = M::SndOwnedBuffer;
    type FstType = <(M::FstHandleBool, <M::FstHandleBool as TyBool>::Neg) as SelectPair>::Selected<
        M::FstType,
    ...
    unsafe fn get_1st_buffer(&mut self) -> Self::FstOwnedBuffer {
        unsafe {
            <(M::FstHandleBool, <M::FstHandleBool as TyBool>::Neg) as SelectPair>::select(
                ...
                mem::transmute_copy::<
                    Box<
                        [[MaybeUninit<<<M::FstHandleBool as TyBool>::Neg as Filter>::Filtered<T>>;
                            D1]; D2],
                    >,
                    Box<
                        MathMatrix<
